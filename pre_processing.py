...
"""
df = function.load_raw()
df_raw = function.load_raw()
...
"""
df = function.make_column(df,'predicted_process_end','process_end','diff_process_end')
df = function.make_column(df,'start_critical_subprocess1','start_subprocess1','diff_subprocess1')
df = function.make_column(df,'expected_start','start_process','diff_process')
df = function.make_column(df,'reported_on_tower','subprocess1_end','diff_on_tower')
